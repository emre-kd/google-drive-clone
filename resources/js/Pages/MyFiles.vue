        ...
        >
          ...
          <div v-else class="flex items-center">
            ...
            <Link
              ...
              class="ml-1 text-sm font-medium md:ml-2 text-gray-700 hover:text-blue-600"
            >
              {{ ans.name }}
            </Link>
          </div>
      ...
      <table class="min-w-full">
        ...
        <tbody>
          <tr
            ...
            class="border-b transition duration-900 ease-in-out hover:bg-blue-100 cursor-pointer"
            :class="
          ...
          >
            ...
            <td
              class="px-6 py-4 max-w-[40px] text-sm font-medium text-gray-900 text-yellow-500"
            >
